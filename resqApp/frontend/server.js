...
const connection = snowflake.createConnection({
    account: process.env.SNOWFLAKE_ACCOUNT || 'https://9rjj6kfe.r.ap-southeast-2.awstrack.me/L0/https:%2F%2Fdfmfctq-km10607.snowflakecomputing.com/1/010801a0cdd3a3e2-237f579d-d1a2-4128-b205-c789247e272f-000000/YqtrLjSHO9DcCBluW7PmQMblyXc=258',
...
app.post('/api/chat', (req, res) => {
    ...
    // Official Snowflake Cortex AI SQL function call using llama3-70b
    const sqlStatement = `
    ...
    connection.execute({
        ...
        complete: (err, stmt, rows) => {
            ...
            // Extract the response generated by Snowflake Cortex AI
            const aiResponse = rows && rows.length > 0 ? rows[0].REPLY : "No response generated.";
